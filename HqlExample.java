...
public class HqlExample {
	...
	System.out.println("-----------------------------------------------------------------------------");
		...
		query1.setLong("E_id",70);                                       //Return value of E_id=20.
    ...
    System.out.println("-----------------------------------------------------------------------------");
		...
		if(deleted==1) {                             //Add deleted records again..
		      ...
		      emp3.setE_id(70);
		      emp3.setE_name("Deleted");
		      emp3.setELast_name("Deleted");
		      emp3.setE_city("satara");      
		      System.out.println(emp3); 
		      
		      session.saveOrUpdate(emp3);                            //Add record in Employee.
		}		
		tx.commit();
	}
}